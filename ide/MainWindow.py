#!/usr/bin/env python
from PyQt5.QtWidgets import (QAction, QApplication, QFileSystemModel, QFontDialog, QHBoxLayout,
                             QInputDialog, QLineEdit, QMainWindow, QMenu, QMenuBar, QMessageBox, QStyleFactory, QTreeView, QWidget)
...
class MainWindow(QMainWindow):
    ...
    def runCustom(self):
        ...
        if self.filename != "":
            ...
            option, ok = QInputDialog().getText(self, "Customized run",
                                                "Enter parameters for sys.argv", QLineEdit.Normal, " ")
            if ok:
